...
from currency.currency_converter.currency_exchange import CurrencyExchange, CurrencyNotAvailableError
...
class CurrencyExchangeTestCase(TestCase):
    ...
    def test_get_available_currencies(self):
        currencies = CurrencyExchange().get_available_currencies()
    ...
    def test_get_exchange_rate(self):
        ...
        with self.assertRaises(CurrencyNotAvailableError):
            exchange_rate = CurrencyExchange().get_exchange_rate(err_from_currency, err_to_currency)
